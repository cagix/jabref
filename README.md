...
|-------------|---------------------|
| [src/test/java/org/jabref/logic/importer/fetcher/SpringerFetcherTest.java](https://github.com/JabRef/jabref/blob/main/src/test/java/org/jabref/logic/importer/fetcher/SpringerFetcherTest.java) | [View File](https://product-map.ai/app/public?url=https://github.com/JabRef/jabref/blob/main/src/test/java/org/jabref/logic/importer/fetcher/SpringerFetcherTest.java ) |

## ProductMap - Contact Us
For any inquiries, feel free to [contact us](https://product-map.ai).
\n\n Last updated on Sat Mar  8 15:40:30 UTC 2025
